    ...
    <header class="app-header">
      <div class="navBar">
        ...
        <div class="btn_actions_experiencePro">
          ...
          >
            <router-link to="/createExperiencePro">
          ...
          >
            <router-link to="/updateExperiencePro">
          ...
          <div class="media">
            <div class="media_body">
              <h2 class="media_title">
                Supprimer les informations concernant votre expérience
                professionnelle
              </h2>
              <div class="reseau">
                <form class="reseau_delete" action="#" method="post">
                  ...
                  <div>
                    <ul>
                      <li class="form">Intitulé du poste : Développeur Web</li>
                      <li class="form">Nom de l'entreprise : SAS exmple</li>
                      <li class="form">Date de début : X/XX/XXXX</li>
                      <li class="form">Date de fin : X/XX/XXXX</li>
                    </ul>
                    <p>
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                      Praesentium consequatur totam ipsam id molestias assumenda
                      similique eum dolorum? Optio, corrupti.
                    </p>
                  </div>
                  <div class="col-5">
                    <img
